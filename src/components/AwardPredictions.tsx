...
const awardsData: AwardResult[] = [
  { name: '金棕榈奖', dividend: 5000.00, predictedWinners: ['盒子里的羊'] },
  { name: '评审团大奖', dividend: 3000.00, predictedWinners: ['平行故事'] },
  { name: '最佳导演', dividend: 2500.00, predictedWinners: ['是枝裕和'] },
  { name: '最佳男演员', dividend: 2000.00, predictedWinners: ['塞巴斯蒂安·斯坦'] },
  { name: '最佳女演员', dividend: 2000.00, predictedWinners: ['桑德拉·惠勒'] },
  { name: '最佳编剧', dividend: 2000.00, predictedWinners: ['阿斯加·法哈蒂'] },
  { name: '评审团奖', dividend: 2000.00, predictedWinners: ['苦涩的圣诞节'] },
  { name: '特别奖（若有）', dividend: 1500.00, predictedWinners: ['待定'] },
];
